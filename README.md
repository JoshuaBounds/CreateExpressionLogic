...
Installation:
  - In you unity project create a new folder in Assets and call it Editor, and place the file in there.
...
Usage:
  ...
  - Ambidextrous Logic: Changes the setup from 64 states where both controllers must give the correct index to achieve each expression. To a setup of just 36 states where the left and right controller indexes can be reversed and still achive the same expression.
